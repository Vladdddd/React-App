...
class App extends Component {
    catchAllUnhandledErrors = (promiseRejectionEvent) => {//"Ловим" необработанные ошибки
...
let AppContainer = compose(//???compose компонирует обработчики. Срабатывают снизу вверх
